    ...
    module Dtos
      class CreateRateDto
        ...
        def initialize(
          ...
          raise TypeError, "origin_direction expected a DirectionEntity or NilClass but got: #{origin_direction.class}" unless origin_direction.is_a?(::Shared::Domain::Entities::DirectionEntity) || origin_direction.is_a?(NilClass)
          raise TypeError, "destination_direction expected a DirectionEntity or NilClass but got: #{destination_direction.class}" unless destination_direction.is_a?(::Shared::Domain::Entities::DirectionEntity) || destination_direction.is_a?(NilClass)
          raise TypeError, "shipment expected a DirectionEntity but got: #{shipment.class}" unless shipment.is_a?(::Shared::Domain::Entities::ShipmentEntity)
          raise TypeError, "accounts expected an AccountsEntity or NilClass but got: #{accounts.class}" unless accounts.is_a?(::Shared::Domain::Entities::AccountsEntity) || accounts.is_a?(NilClass)
