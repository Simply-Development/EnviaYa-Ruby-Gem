        ...
        def initialize(
          ...
          unless surcharges.is_a?(NilClass)
            ...
            surcharges.each do |surcharge|
              raise TypeError, "item in surcharges array expected to be a SurchargeEntity but got: #{surcharge.class}" unless surcharge.is_a?(::Shared::Domain::Entities::SurchargeEntity)
            end
          end
