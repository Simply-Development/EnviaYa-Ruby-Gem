    ...
    module Entities
      class DirectionEntity
        ...
        def initialize(
          ...
          raise TypeError, "postal_code expected a PostalCodeValueObject but got: #{postal_code.class}" unless postal_code.is_a?(::Shared::Domain::ValueObjects::PostalCodeValueObject)
