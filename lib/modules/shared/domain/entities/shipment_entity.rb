      ...
      class ShipmentEntity
        ...
        def initialize(
          ...
          parcels.each do |parcel|
            raise TypeError, "item in parcels array expected to be a ParcelEntity but got: #{parcel.class}" unless parcel.is_a?(::Shared::Domain::Entities::ParcelEntity)
          end
          ...
          raise TypeError, "label_format expected a LabelFormatValueObject or NilClass but got: #{label_format.class}" unless label_format.is_a?(::Shared::Domain::ValueObjects::LabelFormatValueObject) || label_format.is_a?(NilClass)
