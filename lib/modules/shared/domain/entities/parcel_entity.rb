    ...
    module Entities
      class ParcelEntity
        ...
        def initialize(
          ...
          raise TypeError, "quantity expected an Integer but got: #{quantity.class}" unless company.is_a?(Integer)
          raise TypeError, "weight expected a Float but got: #{weight.class}" unless weight.is_a?(Float)
          raise TypeError, "weight_unit expected a WeightUnitValueObject but got: #{weight_unit.class}" unless weight_unit.is_a?(::Shared::Domain::ValueObject::WeightUnitValueObject)
          ...
          raise TypeError, "dimension_unit expected a DimensionUnitValueObject but got: #{dimension_unit}" unless dimension_unit.is_a?(::Shared::Domain::ValueObject::DimensionUnitValueObject)
