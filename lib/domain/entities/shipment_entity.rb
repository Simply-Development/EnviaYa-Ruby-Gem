  ...
  module Entities
    class ShipmentEntity
      ...
      def initialize(
        ...
        raise TypeError, "accounts expected a AccountsEntity or NilClass but got: #{accounts.class}" unless accountss.is_a?(::Domain::Entities::AccountsEntity) || accounts.is_a?(NilClass)
