  ...
  module Entities
    class ParcelEntity
      ...
      def initialize(
        ...
        raise TypeError, "weight_unit expected a WeightUnitValueObject but got: #{weight_unit.class}" unless weight_unit.is_a?(::Domain::ValueObject::WeightUnitValueObject)
        ...
        raise TypeError, "dimension_unit expected a DimensionUnitValueObject but got: #{dimension_unit}" unless dimension_unit.is_a?(::Domain::ValueObject::DimensionUnitValueObject)
